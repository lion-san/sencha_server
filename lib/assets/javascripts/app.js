...
var eventSaid = function(eventId, btnName){
  ...
  //Refresh
  if( refresh ){
    createEventBtn(eventId, btnName, eventForRefresh.operator, eventForRefresh.param );
    return;
  }
...
//Sub Function
//イベント（条件）ボタンの生成
var createEventBtn = function(eventId, btnName, input1, input2){
  ...
  if(input1 == "=="){
    ...
    //JSONのPush
    json = {"event": "say", "type" : "==", "param": input2};
  }
  else{
    out = "部分";
    json = {"event": "say", "type" : "=", "param": input2};
